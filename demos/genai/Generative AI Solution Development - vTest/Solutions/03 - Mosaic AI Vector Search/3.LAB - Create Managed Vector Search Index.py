...
# MAGIC
# MAGIC **🚨NOTE: If you don't have endpoint creation permissions, use the name of endpoint and skip the endpoint creation process.**
# MAGIC
# MAGIC **💡 Instructions:**
# MAGIC
...
# If you want to use existing endpoint, define it here
vs_endpoint_name = "vs_endpoint_lab"

# COMMAND ----------

# IF you want to create a new endpoint
...
# MAGIC ## Task 4: Re-rank Search Results
# MAGIC
# MAGIC You have retreived some documents that are similar to the query text. However, the question which documents are the most relevant is not done by the vector search results. Use `flashrank` library to re-rank the results and show the most relevant top 3 documents. 
# MAGIC
# MAGIC **💡 Instructions:**
# MAGIC
