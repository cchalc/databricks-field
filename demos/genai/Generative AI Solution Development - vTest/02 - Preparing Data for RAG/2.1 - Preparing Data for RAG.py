...
# MAGIC
# MAGIC
# MAGIC **In this demo, we will focus on ingesting pdf documents as source for our retrieval process.** First, we will ingest the PDF files and process them using self-managed vector search embeddings. 
# MAGIC
# MAGIC
...
# MAGIC
# MAGIC * Use the chunking strategy to divide up context information to be provided to a model.
# MAGIC
# MAGIC
...
# MAGIC %pip install transformers==4.30.2 "unstructured[pdf,docx]==0.10.30" langchain==0.1.16 llama-index==0.9.3 pydantic==1.10.9 mlflow==2.9.0
...
# MAGIC %md
# MAGIC **💡 Chunking Overlap**: Review the content chunks and pay attention to the sentence overlap between chunks. This was define with `SentenceSplitter` above.
