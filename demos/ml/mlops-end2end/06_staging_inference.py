...
# MAGIC To run this demo, just select the cluster `dbdemos-mlops-end2end-mark_oswald` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0321-181439-fp8wb6mu/configuration)). <br />
...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&cid=1444828305810485&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-science%2Fmlops-end2end%2F06_staging_inference&uid=687989441193254">
...
# MAGIC * [Explore DBSQL Churn Dashboard](/sql/dashboards/53f3998a-8674-4d20-9279-4af6ef5dce0f-churn-prediction-dashboard---universal?o=1444828305810485#)
