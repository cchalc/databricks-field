...
# MAGIC  %md
# MAGIC
# MAGIC Start your data ingestion from HTML pages: open the [01-Data-Preparation]($./01-Data-Preparation) notebook
# MAGIC
...
# MAGIC %md
# MAGIC ## 4/ Going further with langchain and a more complete chatbot
# MAGIC
# MAGIC Our first chatbot example was simple for the demo requirement.
# MAGIC
# MAGIC Your real time production LLM-apps will likely leverage multiple agents and combine multiple steps.
# MAGIC
# MAGIC Open the [04-Advanced-Chatbot-Chain]($./04-Advanced-Chatbot-Chain) notebook to see how you can improve the chatbot capabilities.
# MAGIC
