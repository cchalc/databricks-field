...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS databricks_pdf_documentation  (id BIGINT GENERATED BY DEFAULT AS IDENTITY, content STRING, url STRING, page INT, total_page INT, ocr_status STRING);
