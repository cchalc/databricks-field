...
experiment_location = '/Shared/feature_store_demo_experiment'
...
feature_lookups = [
    FeatureLookup(
      table_name = 'feature_store_db.ticket_features',
      feature_names = ['CabinChar', 'CabinMulti', 'Embarked', 'FareRounded', 'Parch', 'Pclass'],
      lookup_key = 'PassengerId'
    ),
    FeatureLookup(
      table_name = 'feature_store_db.demographic_features',
...
passengers_and_target = spark.table('feature_store_db.passenger_labels')
...
model_registry_name = 'feature_store_demo_model'
try:
