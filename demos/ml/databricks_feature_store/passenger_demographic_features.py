...
df = spark.table('feature_store_db.passenger_demographic_features')
...
feature_table_name = 'feature_store_db.demographic_features'
...
# MAGIC %md
# MAGIC Droping the feature table:
# MAGIC - underlying delta table: DROP TABLE
# MAGIC - metadata: fs.drop_table

# COMMAND ----------

# MAGIC %sql
# MAGIC 
# MAGIC -- DROP TABLE IF EXISTS feature_store_db.demographic_features;

# COMMAND ----------

# fs.drop_table(
#  name='feature_store_db.demographic_features'
#)
