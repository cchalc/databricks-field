...
df = spark.table('feature_store_db.passenger_ticket_feautures')
...
feature_table_name = 'feature_store_db.ticket_features'
...
# MAGIC %sql
# MAGIC 
# MAGIC -- DROP TABLE IF EXISTS feature_store_db.ticket_features;
