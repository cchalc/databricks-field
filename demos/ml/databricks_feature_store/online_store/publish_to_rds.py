...
demographic_features = (spark.table('feature_store_db.demographic_features')
                             .select('PassengerId','Age', 'NameMultiple', 'NamePrefix', 'Sex', 'SibSp'))

ticket_features = (spark.table('feature_store_db.ticket_features')
...
feature_table_name = 'feature_store_db.online_feature_table'
...
fs.publish_table(name=f'feature_store_db.{table_name}', 
