...
-- MAGIC %md 
-- MAGIC Open the FSI banking & Fraud  <a dbdemos-pipeline-id="dlt-fsi-fraud" href="#joblist/pipelines/988966ef-c9dd-428a-a95f-a8b54b48696e" target="_blank">Delta Live Table pipeline</a> or the [SQL notebook]($./01-Data-ingestion/01.1-DLT-fraud-detection-SQL) *(Alternatives: DLT Python version Soon available)*. <br>
...
-- MAGIC %md 
-- MAGIC Open the [Datawarehousing notebook]($./03-BI-data-warehousing/03-BI-Datawarehousing-fraud) to start running your BI queries or access or directly open the <a href="/sql/dashboards/d1fd04b8-8f26-4b3f-945c-f4d4831856b5" target="_blank">Banking fraud analysis dashboard</a>
