...
-- MAGIC %md
-- MAGIC Your DLT Pipeline has been installed and started for you! Open the <a dbdemos-pipeline-id="dlt-fsi-fraud" href="#joblist/pipelines/988966ef-c9dd-428a-a95f-a8b54b48696e" target="_blank">Fraud detection Delta Live Table pipeline</a> to see it in action.<br/>
...
-- MAGIC
-- MAGIC Open the <a dbdemos-pipeline-id="dlt-fsi-fraud" href="#joblist/pipelines/988966ef-c9dd-428a-a95f-a8b54b48696e" target="_blank">Fraud detection Delta Live Table pipeline</a> and click on start to visualize your lineage and consume the new data incrementally!
