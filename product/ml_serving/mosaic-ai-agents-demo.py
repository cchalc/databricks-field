...
# MAGIC
# MAGIC This tutorial shows you how to build, deploy, and evaluate a RAG application using [Mosaic AI Agent Framework](https://docs.databricks.com/generative-ai/retrieval-augmented-generation.html) and [Mosaic AI Agent Evaluation](https://docs.databricks.com/generative-ai/agent-evaluation/index.html). In this tutorial, you:
# MAGIC
...
# MAGIC
# MAGIC In this example, you build a RAG chatbot that can answer questions using information from [Databricks public documentation](https://docs.databricks.com).
# MAGIC
# MAGIC ## Requirements
# MAGIC
# MAGIC  - This notebook requires a [single-user cluster](https://docs.databricks.com/en/compute/configure.html#access-modes) running on Databricks Runtime 14.3 and above.
...
# MAGIC - [**Agent Framework**](https://docs.databricks.com/generative-ai/retrieval-augmented-generation.html) - An SDK used to quickly and safely build high-quality RAG applications.
# MAGIC - [**Agent Evaluation**](https://docs.databricks.com/generative-ai/agent-evaluation/index.html) - AI-assisted tools that help evaluate if outputs are high-quality. Include an intuitive UI-based review app to get feedback from human stakeholders.
...
# MAGIC
# MAGIC Clone the Generative AI cookbook repo from `https://github.com/databricks/genai-cookbook` into a folder `genai-cookbook` in the same folder as this notebook using a [Git Folder](https://docs.databricks.com/en/repos/index.html).  
# MAGIC
...
# MAGIC
# MAGIC - `UC_CATALOG` and `UC_SCHEMA`: [Unity Catalog](https://docs.databricks.com/en/data-governance/unity-catalog/create-catalogs.html#create-a-catalog) and a Schema where the output Delta tables and Vector Search indexes are stored
# MAGIC - `UC_MODEL_NAME`: Unity Catalog location to log and store the chain's model
# MAGIC - `VECTOR_SEARCH_ENDPOINT`: [Vector Search Endpoint](https://docs.databricks.com/en/generative-ai/create-query-vector-search.html#create-a-vector-search-endpoint) to host the vector index
# MAGIC
...
# MAGIC
# MAGIC Copy the sample data to a Delta table and sync it to a Vector Search index. Use the [gte-large-en-v1.5](https://huggingface.co/Alibaba-NLP/gte-large-en-v1.5) embedding model hosted on [Databricks Foundational Model APIs](https://docs.databricks.com/en/machine-learning/foundation-models/index.html) to create the vector embeddings.
...
# MAGIC
# MAGIC **Your domain experts do NOT need to have Databricks workspace access** - you can assign permissions to any user in your SSO if you have enabled [SCIM](https://docs.databricks.com/en/admin/users-groups/scim/index.html)
# MAGIC
# MAGIC <br/>
# MAGIC
...
# MAGIC
# MAGIC This demo uses a toy 4-question evaluation dataset. To learn more about evaluation best practices, see [best practices]((https://docs.databricks.com/ai-cookbook/implementation/step-3-evaluation-set.html).
...
# MAGIC |------ | ---- | ---- |
# MAGIC | 🕧🕧 <br/>30 minutes | Comprehensive quality/cost/latency evaluation of your proof of concept app | - [Evaluate your proof of concept](https://docs.databricks.com/ai-cookbook/implementation/step-4-evaluate-quality.html) <br/> - [Identify the root causes of quality issues](https://ai-cookbook.io/nbs/5-hands-on-improve-quality-step-1.html) |
# MAGIC
# MAGIC ## Browse the code samples
# MAGIC
# MAGIC Open the `./genai-cookbook/rag_app_sample_code` folder this notebook synced to your Workspace.  Documentation [here](https://ai-cookbook.io/nbs/6-implement-overview.html).
# MAGIC
